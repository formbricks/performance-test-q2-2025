...
export let options = {
        thresholds: {
            ...
            create_survey_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            create_survey_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            delete_survey_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            delete_survey_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            get_survey_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            get_survey_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            create_response_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            create_response_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            update_response_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            update_response_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            get_env_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            get_env_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            post_user_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            post_user_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            list_users_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            list_users_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            add_display_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            add_display_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            list_roles_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            list_roles_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            list_teams_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            list_teams_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            update_survey_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            update_survey_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            publish_survey_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            publish_survey_errors: [{ threshold: 'rate<1', abortOnFail: true }],
            get_environment_latency: [{threshold: 'p(95)<3000', abortOnFail: true}],
            get_environment_errors: [{ threshold: 'rate<1', abortOnFail: true }],
        },
    scenarios: {
        createSurvey: {
